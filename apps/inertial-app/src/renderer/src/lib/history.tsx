...
const SEED: HistoryEntry[] = [
  ...
  },
  {
    ...
    at: minutesAgo(11),
    context: "escalate.mandatory",
  },
  {
    id: "h-3",
    kind: "agent-activity",
    label: "quiet_gardener · toxic 0.58",
    at: minutesAgo(22),
    context: "escalate.discretionary",
  },
  {
    id: "h-4",
    kind: "agent-activity",
    label: "spam_bot_04 · spam-link 0.88",
    at: minutesAgo(34),
    context: "queue.quick",
  },
  {
    id: "h-5",
    kind: "agent-activity",
    label: "Alt Account · identity-hate 0.72",
    at: hoursAgo(1.2),
    context: "queue.deep",
  },
  {
